...
const Education = (props: Props) => {
  ...
  return (
    <div className="h-screen flex flex-col relative items-center text-center ">
      ...
      <div className="flex items-left justify-start absolute top-44 h-[55vh]  w-1 bg-slate-300" />
      <div className="flex flex-col items-center mx-3 relative top-36 ">
        {/* 1 */}
        <div className=" flex flex-col border z-20 rounded-xl w-auto px-6 py-3 bg-[#1b1f3b] space-y-1 text-white">
